...
@section('custom-scripts')
    <script>
        $(function() {
            trackadmin.public.termsAndConditions({
                    ...
                    <div class="col-12 col-md-10 mt-4 mt-md-0 ">
                        <form id="form_maintenance" class="needs-validation" novalidate>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="txtDescription" name="description" rows="3" required>{!! nl2br($content->description) !!}</textarea>
                            </div>
            ...
            <div class=" tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                <div class="row">
                    ...
                    <div class="col-12 col-md-7 mt-4 mt-md-0 ">
                        ...
                        <img src="{{ $content->image }}" alt="" class="img-fluid shadow " id="img-1">

                        <div class="form-group mt-4">
                            <button class="btn-lg btn btn-outline-secondary" id="btn-save-image"><i class="far fa-save"></i>
                                Guardar Cambios</button>
                        </div>
                    </div>
