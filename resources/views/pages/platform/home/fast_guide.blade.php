                ...
                <div class="row">
                    <div class="col-12 col-md-7 mt-4 mt-md-0 ">
                        ...
                        <form id="form_maintenance" class="needs-validation" novalidate>
                            <input type="hidden" value="{{ $fastGuide->id }}" name="id"  id="content_id">
                    ...
                    <div class="col-12 col-md-7 mt-4 mt-md-0 content-images">
                        ...
                        <div class="item-image mt-4">
                                <div class="content-file-img mb-4 d-flex justify-content-between align-items-center">
                                    <h5>Seccion 1</h5>
                                    <button class="btn btn-outline-secondary btn-file btn-sm" img-content="img-{{ $section1->id }}" input-file="fileInputImage_{{ $section1->id }}">
                                        <i class="fas fa-plus"></i> Cargar Imagen
                                    </button>
                                    <input type="file" class="d-none input-file" id="fileInputImage_{{ $section1->id }}" lang="es" item_id="{{ $section1->id }}" accept=".jpg,.png,.jpeg,.svg">
                                </div>
                                <div class="pl-5 pr-5">
                                    <img src="{{$section1->image}}" alt="" class="img-fluid shadow " id="img-{{ $section1->id }}">
                                </div>
                        ...
                        <div class="item-image mt-4">
                                <div class="content-file-img mb-4 d-flex justify-content-between align-items-center">
                                    <h5>Seccion 2</h5>
                                    <button class="btn btn-outline-secondary btn-file btn-sm" img-content="img-{{ $section2->id }}" input-file="fileInputImage_{{ $section2->id }}">
                                        <i class="fas fa-plus"></i> Cargar Imagen
                                    </button>
                                    <input type="file" class="d-none input-file" id="fileInputImage_{{ $section2->id }}" lang="es" item_id="{{ $section2->id }}" accept=".jpg,.png,.jpeg,.svg">
                                </div>
                                <div class="pl-5 pr-5">
                                    <img src="{{$section2->image}}" alt="" class="img-fluid shadow " id="img-{{ $section2->id }}">
                                </div>
                        ...
                        <div class="item-image mt-4">
                                <div class="content-file-img mb-4 d-flex justify-content-between align-items-center">
                                    <h5>Seccion 3</h5>
                                    <button class="btn btn-outline-secondary btn-file btn-sm" img-content="img-{{ $section3->id }}" input-file="fileInputImage_{{ $section3->id }}">
                                        <i class="fas fa-plus"></i> Cargar Imagen
                                    </button>
                                    <input type="file" class="d-none input-file" id="fileInputImage_{{ $section3->id }}" lang="es" item_id="{{ $section3->id }}" accept=".jpg,.png,.jpeg,.svg">
                                </div>
                                <div class="pl-5 pr-5">
                                    <img src="{{$section3->image}}" alt="" class="img-fluid shadow " id="img-{{ $section3->id }}">
                                </div>
