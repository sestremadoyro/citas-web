<?php $__env->startSection('meta-data'); ?>
    ...
    <meta content="<?php echo e(config('app.name', 'Audi')); ?> - Mantenimiento" property="og:title" />
        ...
        $(document).ready(function() {
            $(function() {
                trackadmin.public.maintenance({
                    list: <?php echo json_encode($workshopList, JSON_PRETTY_PRINT, 512) ?>,
                    vehicles: <?php echo json_encode($vehiclesList, JSON_PRETTY_PRINT, 512) ?>,
                })
            })
        });
    </script>
                ...
                <div class="row pt-3" id="two" style="display:none">
                    <div class="col-12 col-md-5 mb-3 ">
                        <select name="" id="ddlDepartament" class="defaultSelect2">
                            <option value=""></option>
                            <?php $__currentLoopData = $departamentList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e(str_replace(' ', '_', $item->departament)); ?>"><?php echo e($item->departament); ?>
...
<?php echo $__env->make('layouts.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/prod/citas-web/resources/views/pages/maintenance.blade.php ENDPATH**/ ?>