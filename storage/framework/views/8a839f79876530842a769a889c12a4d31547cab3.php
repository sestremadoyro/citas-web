<?php $__env->startSection('custom-scripts'); ?>
    <script>
        $(function() {
            trackadmin.public.third_benefice({
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-5">
                        ...
                        <ul class="mt-4">
                            ...
                            <li>Medidas: de 810px de ancho y 600px de alto. </li>
...
<?php echo $__env->make('layouts.platform', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/prod/citas-web/resources/views/pages/platform/benefices/third_benefice.blade.php ENDPATH**/ ?>