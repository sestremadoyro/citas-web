                ...
                <div class="row">
                    <div class="col-12 col-md-7 mt-4 mt-md-0 ">
                        ...
                        <form id="form_maintenance" class="needs-validation" novalidate>
                            <input type="hidden" value="<?php echo e($transparency->id); ?>" name="id">
                            <input type="hidden" value="<?php echo e($section4->id); ?>" id="section4_id" name="section4_id">
                            <input type="hidden" value="<?php echo e($section5->id); ?>" id="section5_id" name="section5_id">
                            <input type="hidden" value="<?php echo e($section6->id); ?>" id="section6_id" name="section6_id">
                            <div class="form-group">
                                <label for="txtPrincipal">Texto principal</label>
                                <input type="text" class="form-control" id="txtPrincipal" name="text_primary"
                                    value="<?php echo e($transparency->text_primary); ?>">
                            </div>

                            <div class="form-group">
                                <label for="txtSecondary">Texto secundario</label>
                                <input type="text" class="form-control" id="txtSecondary" name="text_secondary"
                                    value="<?php echo e($transparency->text_secondary); ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="txtButtonGeneral" name="btn_general"
                                    value="<?php echo e($transparency->btn_general); ?>">
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="txtLinkButtonGeneral" name="link_btn_general"
                                    value="<?php echo e($transparency->link_btn_general); ?>">
                            </div>
                    ...
                    <div class="col-12 col-md-7 mt-4 mt-md-0 content-images">
                        ...
                        <div class="item-image mt-4">
                                <div class="content-file-img mb-4 d-flex justify-content-between align-items-center">
                                    <h5>Seccion 1</h5>
                                    <button class="btn btn-outline-secondary btn-file btn-sm" img-content="img-<?php echo e($section4->id); ?>" input-file="fileInputImage_<?php echo e($section4->id); ?>">
                                        <i class="fas fa-plus"></i> Cargar Imagen
                                    </button>
                                    <input type="file" class="d-none input-file" id="fileInputImage_<?php echo e($section4->id); ?>" lang="es" item_id="<?php echo e($section4->id); ?>" accept=".jpg,.png,.jpeg,.svg">
                                </div>
                                <div class=" pr-5">
                                    <img src="<?php echo e($section4->image); ?>" alt="" class="img-fluid shadow icon-size" id="img-<?php echo e($section4->id); ?>">
                                </div>
                        ...
                        <div class="item-image mt-4">
                                <div class="content-file-img mb-4 d-flex justify-content-between align-items-center">
                                    <h5>Seccion 2</h5>
                                    <button class="btn btn-outline-secondary btn-file btn-sm" img-content="img-<?php echo e($section5->id); ?>" input-file="fileInputImage_<?php echo e($section5->id); ?>">
                                        <i class="fas fa-plus"></i> Cargar Imagen
                                    </button>
                                    <input type="file" class="d-none input-file" id="fileInputImage_<?php echo e($section5->id); ?>" lang="es" item_id="<?php echo e($section5->id); ?>" accept=".jpg,.png,.jpeg,.svg">
                                </div>
                                <div class=" pr-5">
                                    <img src="<?php echo e($section5->image); ?>" alt="" class="img-fluid shadow icon-size" id="img-<?php echo e($section5->id); ?>">
                                </div>
                        ...
                        <div class="item-image mt-4">
                                <div class="content-file-img mb-4 d-flex justify-content-between align-items-center">
                                    <h5>Seccion 3</h5>
                                    <button class="btn btn-outline-secondary btn-file btn-sm" img-content="img-<?php echo e($section6->id); ?>" input-file="fileInputImage_<?php echo e($section6->id); ?>">
                                        <i class="fas fa-plus"></i> Cargar Imagen
                                    </button>
                                    <input type="file" class="d-none input-file" id="fileInputImage_<?php echo e($section6->id); ?>" lang="es" item_id="<?php echo e($section6->id); ?>" accept=".jpg,.png,.jpeg,.svg">
                                </div>
                                <div class=" pr-5">
                                    <img src="<?php echo e($section6->image); ?>" alt="" class="img-fluid shadow icon-size" id="img-<?php echo e($section6->id); ?>">
                                </div>
...
<?php echo $__env->make('layouts.platform', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/prod/citas-web/resources/views/pages/platform/home/transparency.blade.php ENDPATH**/ ?>